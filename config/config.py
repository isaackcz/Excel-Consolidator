...
# Auto-Update Configuration (REMOVED)
# AUTO_UPDATE_ENABLED = False
# Auto-update feature has been removed from the application

# Application Configuration - Import from version.py to avoid duplication
try:
    from src.core.version import APP_NAME, APP_VERSION, APP_DESCRIPTION
except ImportError:
    # Fallback values if version.py is not available
    APP_NAME = "Excel Consolidator"
    APP_VERSION = "1.0.7"
    APP_DESCRIPTION = "Advanced Excel file consolidation tool with optimized performance"
...
def get_github_config():
    ...
    try:
        from src.core.version import GITHUB_OWNER, GITHUB_REPO
        return {
            "owner": GITHUB_OWNER,
            "repo": GITHUB_REPO
        }
